...
const Hero: FC = () => {
  ...
  return (
    <section id="home">
      <div className="sticky top-0 grid md:grid-cols-12 md:h-screen items-stretch">
        <div className="md:col-span-7 flex flex-col justify-center">
          <div className="container !max-w-full">
            ...
            >
              Crafing Digital Experiences Through Code & Create Designs
            </motion.h1>
            
            <div className="flex flex-col md:flex-row items-start md:items-center mt-10 gap-6">
              <motion.div
                ...
                <Button 
                  ...
                  iconAfter={
                    <div className="overflow-hidden size-5">
                      <div className="flex h-5 w-10 group-hover/button:-translate-x-1/2 transition-transform duration-500">
              ...
              >
                <Button className="" variant="text">Let&apos;s Talk</Button>
              </motion.div>
            </div>
          </div>
        </div>
