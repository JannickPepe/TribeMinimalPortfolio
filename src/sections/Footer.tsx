  ...
  return (
    <footer id="contact" className="bg-stone-900 text-white">
      <div className="container">
        <div className="section">
          ...
          <div className="grid md:grid-cols-3 md:items-center">
            <div className="md:col-span-2">
              <h2 ref={scope} className="text-4xl md:text-7xl lg:text-8xl mt-8 font-extralight">
        ...
        <p className="py-16 text-white/50 text-sm">Copyright @NighteCoding 2025 &bull; all rights reserved</p>
      </div>
    </footer>
  )
};
