      ...
      <div className="container">
        ...
        <div className="mt-10 md:mt-16 lg:mt-20">
          {faqs.map(({ question, answer }, faqIndex) => (
            <div 
              key={question} 
              className="relative isolate border-t border-stone-400 border-dotted py-6 md:py-8 lg:py-10 last:border-b group/faq"
              onClick={() => {
            ...
            >
              ...
              <div className={twMerge("flex items-center justify-between gap-4 transition-all duration-700 group-hover/faq:lg:px-8", faqIndex === selectedIndex && "lg:px-8")}>
                ...
                <div 
                  className={
                    twMerge(
                      "inline-flex items-center justify-center size-11 border border-stone-400 rounded-full shrink-0 transition duration-300 bg-stone-200 hover:cursor-pointer", 
                      faqIndex === selectedIndex && 'rotate-45'
                    )
                  }
                >
                  <svg xmlns="http://www.w3.org/2000/" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
