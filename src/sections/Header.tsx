...
const Header: FC = () => {
  ...
  }, [bottomLineAnimate, bottomLineScope, isOpen, topLineAnimate, topLineScope, navScope, navAnimate]);
      ...
      <div className="fixed top-0 left-0 w-full backdrop-blur-md mix-blend-difference">
        <div className="container !max-w-full">
          <div className="flex justify-between items-center h-20">
            <div>
              <Link href={'/'}>
                <span className="text-xl font-bold uppercase text-white hover:cursor-pointer">Minimal&nbsp; Landing</span>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container !max-w-full">
          <div className="flex justify-end items-center h-20">
            <div className="flex items-center gap-4">
              <div 
                className="size-11 bg-stone-200 border border-stone-400 rounded-full inline-flex items-center justify-center hover:cursor-pointer"
